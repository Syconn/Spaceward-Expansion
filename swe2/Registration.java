...
public class Registration {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(BuiltInRegistries.RECIPE_SERIALIZER, Main.MODID);
    ...
    public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.ATTACHMENT_TYPES, Main.MODID);
    public static final DeferredRegister.DataComponents COMPONENTS = DeferredRegister.createDataComponents(Main.MODID);
    public static final DeferredRegister<MapCodec<? extends Block>> BLOCK_TYPES = DeferredRegister.create(BuiltInRegistries.BLOCK_TYPE, Main.MODID);
    ...
    public static final DeferredBlock<BaseFluidPipe> FLUID_PIPE = registerBlockAndItem("fluid_pipe", () -> new BaseFluidPipe(Blocks.GLASS_PANE.properties()));
    ...
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<CanisterFiller>> CANISTER_FILLER_CODEC = BLOCK_TYPES.register("canister_filler", () -> BlockBehaviour.simpleCodec(CanisterFiller::new));
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<FluidTank>> FLUID_TANK_CODEC = BLOCK_TYPES.register("fluid_tank", () -> BlockBehaviour.simpleCodec(FluidTank::new));
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<OxygenCollector>> OXYGEN_COLLECTOR_CODEC = BLOCK_TYPES.register("oxygen_collector", () -> BlockBehaviour.simpleCodec(OxygenCollector::new));
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<OxygenDisperser>> OXYGEN_DISPERSER_CODEC = BLOCK_TYPES.register("oxygen_disperser", () -> BlockBehaviour.simpleCodec(OxygenDisperser::new));
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<DispersibleAirBlock>> OXYGEN_CODEC = BLOCK_TYPES.register("oxygen_dispersible", () -> BlockBehaviour.simpleCodec(DispersibleAirBlock::new));
    public static final DeferredHolder<MapCodec<? extends Block>, MapCodec<BaseFluidPipe>> FlUID_PIPE_CODEC = BLOCK_TYPES.register("fluid_pipe", () -> BlockBehaviour.simpleCodec(BaseFluidPipe::new));
    ...
    public static final Holder<ArmorMaterial> SPACE_SUIT_MATERIAL = ARMOR_MATERIALS.register("space_suit", () -> new ArmorMaterial(SpaceArmor.DEFENSE, 20,
                    SoundEvents.ARMOR_EQUIP_GENERIC, () -> Ingredient.of(Tags.Items.INGOTS_IRON), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Main.MODID, "space_suit"))),0,0));
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> NEXUS_TAB = TABS.register("nexus", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup." + Main.MODID)).icon(() -> SPACE_HELMET.get().getDefaultInstance()).build());
    ...
    public static final TagKey<Item> CANISTERS = ItemTags.create(Main.loc("canisters"));

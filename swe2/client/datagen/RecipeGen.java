...
public class RecipeGen extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        CustomRecipeBuilder.special(DyedParachuteRecipe::new).save(pRecipeOutput, Main.loc("dyed_parachute"), RecipeProvider.has(ItemTags.WOOL));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, Registration.CANISTER_FILLER.get())
                ...
                .unlockedBy("has_mats", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.IRON_BLOCK, Items.GOLD_INGOT).build()))
                .save(pRecipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.NETHERITE_UPGRADE.get())
                ...
                .unlockedBy("has_ingot", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.NETHERITE_INGOT).build()))
                .save(pRecipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.DIAMOND_UPGRADE.get())
                ...
                .unlockedBy("has_ingot", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.DIAMOND).build()))
                .save(pRecipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.EMERALD_UPGRADE.get())
                ...
                .unlockedBy("has_ingot", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.EMERALD).build()))
                .save(pRecipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.GOLD_UPGRADE.get())
                ...
                .unlockedBy("has_ingot", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.GOLD_INGOT).build()))
                .save(pRecipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.IRON_UPGRADE.get())
                ...
                .unlockedBy("has_ingot", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.IRON_INGOT).build()))
                .save(pRecipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, Registration.FLUID_PIPE.get(), 4)
                ...
                .unlockedBy("has_bucket", RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.BUCKET).build()))
                .save(pRecipeOutput);

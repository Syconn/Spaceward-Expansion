...
public class PipeBakedModel implements BakedModel {
    ...
    static {
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, false, false, false), PipeUtil.QuadSetting.of(SPRITE_NONE, 0));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, false, false, false), PipeUtil.QuadSetting.of(SPRITE_END, 3));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, true, false, false), PipeUtil.QuadSetting.of(SPRITE_END, 0));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, false, true, false), PipeUtil.QuadSetting.of(SPRITE_END, 1));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, false, false, true), PipeUtil.QuadSetting.of(SPRITE_END, 2));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, true, false, false), PipeUtil.QuadSetting.of(SPRITE_CORNER, 0));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, true, true, false), PipeUtil.QuadSetting.of(SPRITE_CORNER, 1));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, false, true, true), PipeUtil.QuadSetting.of(SPRITE_CORNER, 2));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, false, false, true), PipeUtil.QuadSetting.of(SPRITE_CORNER, 3));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, true, false, true), PipeUtil.QuadSetting.of(SPRITE_STRAIGHT, 0));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, false, true, false), PipeUtil.QuadSetting.of(SPRITE_STRAIGHT, 1));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, true, true, false), PipeUtil.QuadSetting.of(SPRITE_THREE, 0));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(false, true, true, true), PipeUtil.QuadSetting.of(SPRITE_THREE, 1));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, false, true, true), PipeUtil.QuadSetting.of(SPRITE_THREE, 2));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, true, false, true), PipeUtil.QuadSetting.of(SPRITE_THREE, 3));
        PipeUtil.PATTERNS.put(PipeUtil.Pattern.of(true, true, true, true), PipeUtil.QuadSetting.of(SPRITE_CROSS, 0));
    }

    public PipeBakedModel(boolean facade, double size, String[] locations) {
        this.facade = facade;
        this.size = size;
    ...
    private TextureAtlasSprite getTexture(int i) {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(Constants.withId(locations[i]));
    }

    private TextureAtlasSprite getSpriteNormal(PipeUtil.SpriteIdx idx) {
        initTextures();
        return switch (idx) {
    ...
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @NotNull RandomSource rand) {
        ...
        if (side == null) {
            PipeUtil.PipeConnectionTypes north, south, west, east, up, down;
            if (state != null) {
                ...
                north = south = west = east = up = down = PipeUtil.PipeConnectionTypes.NONE;
            }

            TextureAtlasSprite spriteCable = spriteNormalCable;
            Function<PipeUtil.SpriteIdx, TextureAtlasSprite> spriteGetter = this::getSpriteNormal;
            ...
            if (up == CABLE) {
                ...
                PipeUtil.QuadSetting pattern = PipeUtil.findPattern(west, south, east, north);
            ...
            if (down == CABLE) {
                ...
                PipeUtil.QuadSetting pattern = PipeUtil.findPattern(west, north, east, south);
            ...
            if (east == CABLE) {
                ...
                PipeUtil.QuadSetting pattern = PipeUtil.findPattern(down, north, up, south);
            ...
            if (west == CABLE) {
                ...
                PipeUtil.QuadSetting pattern = PipeUtil.findPattern(down, south, up, north);
            ...
            if (north == CABLE) {
                ...
                PipeUtil.QuadSetting pattern = PipeUtil.findPattern(west, up, east, down);
            ...
            if (south == CABLE) {
                ...
                PipeUtil.QuadSetting pattern = PipeUtil.findPattern(west, down, east, up);

...
public class ChuteModel extends Model {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Constants.withId("chute"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		test.render(poseStack, buffer, packedLight, packedOverlay, 1.0f, 1.0f, 1.0f, 1.0f);
		test2.render(poseStack, buffer, packedLight, packedOverlay, 1.0f, 1.0f, 1.0f, 1.0f);
		brella.render(poseStack, buffer, packedLight, packedOverlay, red, blue, green, alpha);
		brella2.render(poseStack, buffer, packedLight, packedOverlay, red, blue, green, alpha);
	}
}
...
public class ParachuteModel extends Model {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Constants.withId("parachute"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		...
		bottom.render(poseStack, buffer, packedLight, packedOverlay, 1.0f, 1.0f, 1.0f, alpha);
	}
}
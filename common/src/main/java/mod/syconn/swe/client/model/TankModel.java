...
public class TankModel extends Model {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Constants.withId("tank"), "main");
	...
	public void render(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float[] red, float[] green, float[] blue, float[] alpha) {
		chamber1.render(poseStack, vertexConsumer, packedLight, packedOverlay, red[1], green[1], blue[1], alpha[1]);
		chamber2.render(poseStack, vertexConsumer, packedLight, packedOverlay, red[1], green[1], blue[1], alpha[1]);
		glass.render(poseStack, vertexConsumer, packedLight, packedOverlay, 255.0f, 255.0f, 255.0f, 255.0f);
		fluid.render(poseStack, vertexConsumer, packedLight, packedOverlay, red[0], green[0], blue[0], alpha[0]);
		top.render(poseStack, vertexConsumer, packedLight, packedOverlay, 255.0f, 255.0f, 255.0f, 255.0f);
	}
